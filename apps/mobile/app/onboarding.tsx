...
const pages = [
  ...
  { eyebrow: '원장 분리', title: '연습과 실제 기록을\n섞지 않아요', body: '실제 거래는 직접 등록합니다. 연습 주문은 다음 거래 가능일 Mock 시가에 처리됩니다.', points: ['자동 실주문 없음', '부분매도 뒤 잔여 수량 감시', '공식 랭킹은 잠긴 전략만 자동 가상 체결'] },
  ...
  return (
    <Screen contentContainerStyle={styles.content}>
      ...
      <View style={{ gap: spacing.sm }}>
        ...
        <Button label={page === 2 ? '체험으로 시작' : '다음'} onPress={() => next(true)} />
